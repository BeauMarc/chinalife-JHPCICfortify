...
const DocItem = React.memo(({ title, isRead, onClick }: DocItemProps) => (
  <div
    onClick={onClick}
...
const PaymentBtn = React.memo(({ type, isActive, onClick }: PaymentBtnProps) => (
...
const VerifyModule = ({ mobile }: { mobile: string }) => {
...
const CheckStep = ({ onComplete, data }: CheckStepProps) => {
...
const SignStep = ({ onComplete }: SignStepProps) => {
...
const PayStep = ({ data }: PayStepProps) => {
